...
public final class VertxRuntime {
  ...
  public static synchronized void install(Map<String, Object> bindings) {
    ...
    // install Object.assign (required my react.js for example)
    ...
    vertx.eventBus().registerDefaultCodec(ScriptObjectMirror.class, new NashornJSObjectMessageCodec(json, java));
  }
}
